...
from Menu_registro_empleado import Ui_Dialog as RegistroEmpleadoUI, RegistroVentana
...
class MenuPrincipal(QtWidgets.QDialog):
    ...
    def abrir_registro_empleado(self):
        self.registro_win = RegistroVentana(self)
        self.registro_win.ui.btnIngresar.clicked.connect(self.registro_win.guardar_datos)
        self.registro_win.ui.btnIngresar_2.clicked.connect(self.volver_menu)
