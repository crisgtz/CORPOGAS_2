...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Registro de Empleados"))
...
class RegistroVentana(QtWidgets.QDialog):
    ...
    def guardar_datos(self):
        ...
        # Validar nombre
        if empleado == "" or empleado == "Nombre de Usuario":
            QtWidgets.QMessageBox.warning(self, "Error", "El nombre del empleado no puede estar vacío.")
            return
        ...
        if self.ui.radioButton.isChecked():
            ...
            QtWidgets.QMessageBox.warning(self, "Error", "Debe seleccionar un turno.")
            return
        try:
            ...
            QtWidgets.QMessageBox.information(
                ...
                f"Registro de {empleado} guardado correctamente."
            )
